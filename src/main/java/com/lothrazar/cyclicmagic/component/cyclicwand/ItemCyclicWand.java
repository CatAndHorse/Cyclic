...
import com.lothrazar.cyclicmagic.event.EventRenderWorld;
import com.lothrazar.cyclicmagic.event.EventRenderWorld.RenderLoc;
...
public class ItemCyclicWand extends Item implements IHasRecipe, IHasConfig {
  ...
  public void syncConfig(Configuration config) {
    ...
    if (RenderLoc.TOPLEFT.name().toLowerCase().equals(renderLocation)) {
      EventRenderWorld.renderLocation = RenderLoc.TOPLEFT;
    }
    else if (RenderLoc.TOPRIGHT.name().toLowerCase().equals(renderLocation)) {
      EventRenderWorld.renderLocation = RenderLoc.TOPRIGHT;
    }
    else if (RenderLoc.BOTTOMLEFT.name().toLowerCase().equals(renderLocation)) {
      EventRenderWorld.renderLocation = RenderLoc.BOTTOMLEFT;
    }
    else if (RenderLoc.BOTTOMRIGHT.name().toLowerCase().equals(renderLocation)) {
      EventRenderWorld.renderLocation = RenderLoc.BOTTOMRIGHT;
    }
    else {
      EventRenderWorld.renderLocation = RenderLoc.BOTTOMLEFT;
    }
